...
function showAnalog(both = false) {
    try {
        $('#clock-contents').html('<div id="keithapps-clock" style="position: fixed;">' +
            '<img id="keithapps-clockImg" style="position: absolute; height: 100%;" src="http://keithmackay.com/imagesclock-circle2N.png" />' + '</div>');
        var clockEl = $("#keithapps-clock");
        clockEl.fadeOut(0);
        if ($('#keithapps-secondParent')) $('#keithapps-secondParent').remove();
        clockEl.append('<div id="keithapps-secondParent" style="height: 100%; width: 100%; position: absolute;">' + '<img id="keithapps-clockSecond" src="http://keithmackay.com/imagesclock-hand2.png" style="position: absolute; height: 50%; top: 5px;" />' + '</div>');
        clockEl.append('<div id="keithapps-minuteParent" style="height: 100%; width: 100%; position: absolute; ">' + '<img id="keithapps-clockMinute" src="http://keithmackay.com/imagesclock-hand2.png" style="position: absolute; height: 50%; padding-top: 10%; top: 5px; z-index: 0;" />' + '</div>');
        clockEl.append('<div id="keithapps-hourParent" style="height: 100%; width: 100%; position: absolute; z-index: 100">' + '<img id="keithapps-clockHour" src="http://keithmackay.com/imagesclock-handRed2.png" style="position: absolute; height: 50%; padding-top: 18%; top: 5px; " />' + '</div>');
