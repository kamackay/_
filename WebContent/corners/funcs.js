...
function showWatermark(anim = true) {
  ...
  var place = function(time = 10) {
    $("#watermark").animate(
      { left: $(window).width() - 200, top: 0 },
      { duration: time, queue: false, easing: "swing" }
    );
...
function collapseSettings(opt = "") {
  ...
  if (settingsEl.length) {
    ...
    settingsEl.animate(
      ...
      { duration: opt === "fast" ? 1 : 500, queue: false }
    );
...
function expandSettings(force = true) {
  ...
  if (settingsEl.length) {
    settingsEl
      ...
      .animate({ left: 0 }, { duration: 1500, queue: false });
    var shortcut = $("#settingsShortcut");
        ...
        t.hover(
          function() {
            t.animate(
              ...
              { duration: 500, queue: false }
            ).animate({ color: colors.white }, { duration: 500, queue: false });
          },
          function() {
            t.animate(
              { backgroundColor: colors.white },
              { duration: 500, queue: false }
            ).animate({ color: colors.black }, { duration: 500, queue: false });
          }
        );
      });
  };
