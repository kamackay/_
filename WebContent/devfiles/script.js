...
function convertToGoogleSearch(e) {
	for (var o = 'https://www.google.com/webhp#q=', t = 0, i = e.length; i > t; t++) o += ' ' == e[t] ? '+' : '#' == e[t] ? '%23' : '/' == e[t] ? '%2F' : '%' == e[t] ? '%25' : '@' == e[t] ? '%40' : '`' == e[t] ? '%60' : '=' == e[t] ? '%3d' : '+' == e[t] ? '%2b' : '\\' == e[t] ? '%5c' : e[t];
	return o
}
...
function devToolsOpen() {
    return (window.chrome) ? (window.outerHeight - window.innerHeight) > 100 || (window.outerWidth - window.innerWidth) > 100 : false;
}
